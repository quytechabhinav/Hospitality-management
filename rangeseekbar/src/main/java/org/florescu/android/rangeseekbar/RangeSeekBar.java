...
public class RangeSeekBar<T extends Number> extends ImageView {
     ...
     */
    public static final int ACTIVE_COLOR = Color.parseColor("#7EB800"/*#388e3c*/);
    /**
    ...
    private static final int DEFAULT_TEXT_DISTANCE_TO_BUTTON_IN_DP = 5;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs == null) {
            ...
            mTextAboveThumbsColor = Color.parseColor(/*"#BA599C"*/"#666666");
            ...
            try {
                ...
                mTextAboveThumbsColor = a.getColor(R.styleable.RangeSeekBar_textAboveThumbsColor, Color.parseColor("#666666"));

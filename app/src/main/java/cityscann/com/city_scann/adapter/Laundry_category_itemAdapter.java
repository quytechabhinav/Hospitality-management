...
public class Laundry_category_itemAdapter extends RecyclerView.Adapter<Laundry_category_itemAdapter.ViewHolder> {
    ...
    public Laundry_category_itemAdapter(Context context,ArrayList<String> names,ArrayList<String> images,ArrayList<String> price,ArrayList<String>it_id,ArrayList<String> sdescription) {
    ...
    @Override
    public Laundry_category_itemAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.laundry_category_item_adapter, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final Laundry_category_itemAdapter.ViewHolder viewHolder, final int i) {

...
public class ResturentcardAdopter extends RecyclerView.Adapter<ResturentcardAdopter.ViewHolder>  {
    ...
    public ResturentcardAdopter(Context context,ArrayList<String> Oredr_Itemname,ArrayList<String> Oredr_Quentity,ArrayList<String> Oredr_COST,ArrayList<String> Oredr_TOTAL,ArrayList<String> order_ID) {
    ...
    public ResturentcardAdopter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.resturentcard_adopter, viewGroup, false);
        return new ResturentcardAdopter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(ResturentcardAdopter.ViewHolder holder, int i) {
    ...
    private void additemoncart() {
        ...
        StringRequest stringRequest = new StringRequest(context.getString(R.string.ip_address)+DATA_URL+"?item_id="+item_ID+"&quantity="+a+"&h_id="+preferencesClass.getHid(), new Response.Listener<String>() {
            @Override

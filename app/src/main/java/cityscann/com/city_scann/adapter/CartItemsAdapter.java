...
public class CartItemsAdapter extends RecyclerView.Adapter<CartItemsAdapter.ViewHolder>  {
    ...
    public CartItemsAdapter(Context context,ArrayList<String> Oredr_Itemname,ArrayList<String> Oredr_Quentity,ArrayList<String> Oredr_COST,ArrayList<String> Oredr_TOTAL,ArrayList<String> order_ID) {
    ...
    public CartItemsAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.cartitemgrid, viewGroup, false);
        return new CartItemsAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(CartItemsAdapter.ViewHolder holder, int i) {
    ...
    private void additemoncart() {
        ...
        Log.d("UpdateData",context.getString(R.string.ip_address)+DATA_URL+"?item_id="+item_ID+"&quantity="+a+"&h_id="+preferencesClass.getHid()+"&uid="+preferencesClass.getphone());
        StringRequest stringRequest = new StringRequest(context.getString(R.string.ip_address)+DATA_URL+"?item_id="+item_ID+"&quantity="+a+"&h_id="+preferencesClass.getHid()+"&uid="+preferencesClass.getphone(), new Response.Listener<String>() {
            @Override

...
public class Bar_Item_Adopter extends RecyclerView.Adapter<Bar_Item_Adopter.ViewHolder> {
    ...
    public Bar_Item_Adopter(Context context,ArrayList<String> names,ArrayList<String> images,ArrayList<String> price,ArrayList<String>it_id,ArrayList<String> sdescription) {
    ...
    @Override
    public Bar_Item_Adopter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.bar__item__adopter, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final Bar_Item_Adopter.ViewHolder viewHolder, final int i) {
...
*/
    ...
    private void additemoncart() {
        ...
        StringRequest stringRequest = new StringRequest(context.getString(R.string.ip_address)+DATA_URL+"?item_id="+ItemID+"&quantity="+itemquentity+"&h_id="+preferencesClass.getHid()+"&type="+"bar"+"&uid="+preferencesClass.getphone()+"&mobile="+preferencesClass.getMobilenu()+"&room_no="+preferencesClass.getRoomNu(), new Response.Listener<String>() {

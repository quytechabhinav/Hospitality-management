...
public class HousekeepingCardAddopter extends RecyclerView.Adapter<HousekeepingCardAddopter.ViewHolder>  {
    ...
    public HousekeepingCardAddopter(Context context,ArrayList<String> Oredr_Itemname,ArrayList<String> Oredr_Quentity,ArrayList<String> Oredr_COST,ArrayList<String> Oredr_TOTAL,ArrayList<String> order_ID) {
    ...
    public HousekeepingCardAddopter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.housekeeping_card_addopter, viewGroup, false);
        return new HousekeepingCardAddopter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(HousekeepingCardAddopter.ViewHolder holder, int i) {
    ...
    private void additemoncart() {
        ...
        StringRequest stringRequest = new StringRequest(context.getString(R.string.ip_address)+DATA_URL+"?item_id="+item_ID+"&quantity="+a+"&h_id="+preferencesClass.getHid()+"&type="+"Keeping", new Response.Listener<String>() {
            @Override

...
public class house_keeping extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layoutManager = new LinearLayoutManager(house_keeping.this);
        ...
        Opencart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(house_keeping.this,HouseKeepingCart.class);
    ...
    private void getData(){
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(getResources().getString(R.string.ip_address)+DATA_URL+"?type="+3+"&h_id="+preferencesClass.getHid()+"&token="+preferencesClass.getUserToken(),new Response.Listener<JSONArray>() {
            @Override
            ...
            private void showGrid(JSONArray jsonArray) {
                ...
                House_keeping_Adapter adapter = new House_keeping_Adapter(house_keeping.this,names,categoryid,image);
    ...
    private void defineviewforitem() {
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(house_keeping.this, Licence_agreement.class);
                startActivity(i);
                finish();
            }
        });
...
*/
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.img1:
                Intent intent = new Intent(house_keeping.this, selection_hotel.class);
                startActivity(intent);
                break;
           ...
           /* case R.id.img3:
            ...
            case R.id.img4:
                final Dialog dialog = new Dialog(house_keeping.this);

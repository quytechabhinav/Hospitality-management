...
public class Spa_category extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.spa_category);
        defineviewforitem();
        ...
        Opencart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Intent intent=new Intent(Spa_category.this,CartItems.class);
    ...
    private void getData(){
        ...
        Log.d("Tol",getResources().getString(R.string.ip_address)+DATA_URL+"?type="+type+"&h_id="+preferencesClass.getHid()+"&token="+preferencesClass.getUserToken());
            ...
            private void showGrid(JSONArray jsonArray) {
                ...
                for(int i = 0; i<jsonArray.length(); i++){
                    ...
                    try {
                        ...
                        mid.add(obj.getString(M_ID));

                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                }
                Spa_adapter adapter = new Spa_adapter(Spa_category.this,names,categoryid,image,mid);
    ...
    private void defineviewforitem() {
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(Spa_category.this, Licence_agreement.class);
                startActivity(i);
                finish();
            }
        });
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.img1:
                Intent intent = new Intent(Spa_category.this, selection_hotel.class);
                startActivity(intent);
                break;
           ...
           /* case R.id.img3:
            ...
            case R.id.img4:
                final Dialog dialog = new Dialog(Spa_category.this);

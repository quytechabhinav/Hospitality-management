...
import cityscann.com.city_scann.adapter.Housekeeping_category_itemAdaptor;
...
public class Housekeeping_category_item extends AppCompatActivity implements View.OnClickListener {
    String cat_id,CATNAME;
    //Web api url
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.housekeeping_category_item);
        defineviewforitem();
        ...
        Opencart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(Housekeeping_category_item.this,HouseKeepingCart.class);
    ...
    private void getData(){
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(getResources().getString(R.string.ip_address)+DATA_URL+"?m_id="+cat_id+"&type="+3+"&h_id="+preferencesClass.getHid()+"&token="+preferencesClass.getUserToken(),
                new Response.Listener<JSONArray>() {
                    ...
                    private void showGrid(JSONArray jsonArray) {
                        ...
                        Housekeeping_category_itemAdaptor adapter = new Housekeeping_category_itemAdaptor(Housekeeping_category_item.this,names,images,price,it_ids,sdescription);
    ...
    private void defineviewforitem() {
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(Housekeeping_category_item.this, Licence_agreement.class);
                startActivity(i);
                finish();
            }
        });
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.img1:
                Intent intent = new Intent(Housekeeping_category_item.this, selection_hotel.class);
                startActivity(intent);
                break;
           ...
           /* case R.id.img3:
                ...
                break;
            case R.id.img4:
                final Dialog dialog = new Dialog(Housekeeping_category_item.this);

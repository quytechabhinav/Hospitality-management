...
import cityscann.com.city_scann.adapter.SPA_main_Adapter;
import cityscann.com.city_scann.adapter.Spa_adapter;
import cityscann.com.city_scann.utils.AppController;
import cityscann.com.city_scann.utils.PreferencesClass;

/**
 * Created by Abhinav on 05-05-2017.
 */

public class E_SPA_category extends AppCompatActivity implements View.OnClickListener {
    ...
    public static final String DATA_URL = "request_spa_all_cat.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.e_menu_category);
        defineviewforitem();
...
//        Log.d("typeFood",type);
        ...
        layoutManager = new LinearLayoutManager(E_SPA_category.this);
    ...
    private void getData(){
        ...
        Log.d("Spacategort",getResources().getString(R.string.ip_address)+DATA_URL+"?type="+type+"&h_id="+preferencesClass.getHid());
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(getResources().getString(R.string.ip_address)+DATA_URL+"?type="+type+"&h_id="+preferencesClass.getHid()+"&token="+preferencesClass.getUserToken(),new Response.Listener<JSONArray>() {
            ...
            private void showGrid(JSONArray jsonArray) {
                ...
                SPA_main_Adapter adapter = new SPA_main_Adapter(E_SPA_category.this,names,categoryid,image);
    ...
    private void defineviewforitem() {
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(E_SPA_category.this, Licence_agreement.class);
                startActivity(i);
                finish();
            }
        });
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.img1:
                Intent intent = new Intent(E_SPA_category.this, selection_hotel.class);
           ...
           /* case R.id.img3:
            ...
            case R.id.img4:
                final Dialog dialog = new Dialog(E_SPA_category.this);

...
import cityscann.com.city_scann.adapter.Spa_category_itemAdapter;
...
public class SPA_category_item extends AppCompatActivity implements View.OnClickListener {
    String cat_id,spa_id,CATNAME;
    //Web api url
    public static final String DATA_URL = "request_spa_all_item.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.spa_category_item);
        defineviewforitem();

        Bundle bundle = getIntent().getExtras();
        spa_id = bundle.getString("SPA_ID");
    ...
    private void getData(){
        ...
        Log.d("SPA_ITEM",getResources().getString(R.string.ip_address)+DATA_URL+"?m_id="+cat_id+"&type="+spa_id+"&h_id="+preferencesClass.getHid());
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(getResources().getString(R.string.ip_address)+DATA_URL+"?m_id="+cat_id+"&type="+spa_id+"&h_id="+preferencesClass.getHid()+"&token="+preferencesClass.getUserToken(),
                new Response.Listener<JSONArray>() {
                    ...
                    private void showGrid(JSONArray jsonArray) {
                        ...
                        Spa_category_itemAdapter adapter = new Spa_category_itemAdapter(SPA_category_item.this,names,images,price,it_ids,sdescription);
    ...
    private void defineviewforitem() {
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(SPA_category_item.this, Licence_agreement.class);
                startActivity(i);
                finish();
            }
        });
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.img1:
                Intent intent = new Intent(SPA_category_item.this, selection_hotel.class);
           ...
           /* case R.id.img3:
                ...
                break;
            case R.id.img4:
                final Dialog dialog = new Dialog(SPA_category_item.this);

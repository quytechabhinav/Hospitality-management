...
public class E_menu_category extends AppCompatActivity implements View.OnClickListener {
...
//        Log.d("typeFood",type);
        ...
        layoutManager = new LinearLayoutManager(E_menu_category.this);
       ...
       /* mLayoutManager = new LinearLayoutManager(
        ...
        Opencart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(E_menu_category.this,HouseKeepingCart.class);
       ...
       //Creating a json array request to get the json from our api
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(getResources().getString(R.string.ip_address)+DATA_URL+"?type="+type+"&h_id="+preferencesClass.getHid()+"&token="+preferencesClass.getUserToken(),new Response.Listener<JSONArray>() {
            ...
            private void showGrid(JSONArray jsonArray) {
                ...
                E_menu_Adapter adapter = new E_menu_Adapter(E_menu_category.this,names,categoryid,image);
    ...
    private void defineviewforitem() {
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(E_menu_category.this, Licence_agreement.class);
                startActivity(i);
                finish();
            }
        });
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.img1:
                Intent intent = new Intent(E_menu_category.this, selection_hotel.class);
                startActivity(intent);
                break;
           ...
           /* case R.id.img3:
            ...
            case R.id.img4:
                final Dialog dialog = new Dialog(E_menu_category.this);

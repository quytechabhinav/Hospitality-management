...
import cityscann.com.city_scann.adapter.Laundry_category_itemAdapter;
...
public class Laundry_category_item extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.laundry_category_item);
        defineviewforitem();
        ...
        Opencart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(Laundry_category_item.this,HouseKeepingCart.class);
    ...
    private void getData(){
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(getResources().getString(R.string.ip_address)+DATA_URL+"?m_id="+cat_id+"&type="+2+"&h_id="+preferencesClass.getHid()+"&token="+preferencesClass.getUserToken(),
                new Response.Listener<JSONArray>() {
                    ...
                    private void showGrid(JSONArray jsonArray) {
                        ...
                        Laundry_category_itemAdapter adapter = new Laundry_category_itemAdapter(Laundry_category_item.this,names,images,price,it_ids,sdescription);
    ...
    private void defineviewforitem() {
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(Laundry_category_item.this, Licence_agreement.class);
                startActivity(i);
                finish();
            }
        });
...
*/
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.img1:
                Intent intent = new Intent(Laundry_category_item.this, selection_hotel.class);
                startActivity(intent);
                break;
           ...
           /* case R.id.img3:
                ...
                break;
            case R.id.img4:
                final Dialog dialog = new Dialog(Laundry_category_item.this);
